 ...
 * Based on the DeepSeek API implementation
 */
class DeepSeekGenerator(apiKey: String?, variant: String?) : CommitGenerator(apiKey, variant) {
    ...
    override val modelName: String = "deepseek"
    override val defaultVariant: String = ModelVariants.getDefaultVariant("deepseek")
