 ...
 * Based on the OpenAIGenerator from the reference implementation
 */
class OpenAIGenerator(apiKey: String?, variant: String?) : CommitGenerator(apiKey, variant) {
    ...
    override val modelName: String = "openai"
    override val defaultVariant: String = ModelVariants.getDefaultVariant("openai")
