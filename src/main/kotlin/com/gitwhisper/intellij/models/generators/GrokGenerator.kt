...
/**
 * Grok (X.AI) commit message generator
 * Based on the Grok API implementation
 */
class GrokGenerator(apiKey: String?, variant: String?) : CommitGenerator(apiKey, variant) {
    ...
    override val modelName: String = "grok"
    override val defaultVariant: String = ModelVariants.getDefaultVariant("grok")
