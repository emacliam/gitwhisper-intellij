...
/**
 * Llama (Meta) commit message generator
 * Based on the Llama API implementation via Together AI
 */
class LlamaGenerator(apiKey: String?, variant: String?) : CommitGenerator(apiKey, variant) {
    ...
    override val modelName: String = "llama"
    override val defaultVariant: String = ModelVariants.getDefaultVariant("llama")
